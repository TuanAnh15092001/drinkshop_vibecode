...
```ts
import { useAddNewList, useGetMyLists, useAddMovieToList, useGetMoviesInList } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useAddNewList(addNewListVars);
...
```js
import { addNewList, getMyLists, addMovieToList, getMoviesInList } from '@dataconnect/generated';


// Operation AddNewList:  For variables, look at type AddNewListVars in ../index.d.ts
